...
import * as workflow_generate_replies_0 from "/home/claude/gs-20260630-aimani-gs/apps/agent/src/workflows/generate-replies.ts";

import userApp from "/home/claude/gs-20260630-aimani-gs/apps/agent/src/app.ts";
...
const workflowModules = {
  "generate-replies": workflow_generate_replies_0,
};
...
const workflowIdentities = {
  "generate-replies": { bindingName: "FLUE_GENERATE_REPLIES_WORKFLOW", className: "FlueGenerateRepliesWorkflow" },
};

const userCloudflare = {};
const reservedCloudflareExportNames = new Set(["FlueGenerateRepliesWorkflow","FlueRegistry"]);
...
const workflowExtension0 = resolveCloudflareExtension(workflowModules["generate-replies"], "generate-replies", 'Workflow');
const FlueGenerateRepliesWorkflow = class FlueGenerateRepliesWorkflow extends workflowExtension0.base(Agent) {
  async onRequest(request) {
    return dispatchWorkflow(request, this, "generate-replies");
  }

  async onFiberRecovered(ctx) {
    if (ctx.name?.startsWith('flue:workflow:')) {
      return handleFlueWorkflowFiberRecovered(ctx, this, "generate-replies");
    }
...
const WrappedFlueGenerateRepliesWorkflow = workflowExtension0.wrap(FlueGenerateRepliesWorkflow);
export { WrappedFlueGenerateRepliesWorkflow as FlueGenerateRepliesWorkflow };
